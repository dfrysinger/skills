...
and end the turn. This overwrites the live conversation in place, so unlike
`/new` there is no old session to resume. The helper's watcher, not selected
autopilot mode, owns the post-compact wakeup.
