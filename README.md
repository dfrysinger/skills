...
- **[shipping](./skills/shipping/SKILL.md)** : Size development process to the actual risk: bounded bug fixes use focused regression tests and a short review path; systemic and critical changes add durable design, architecture guards, and final live proof. Uses [`dual-review`](./skills/dual-review/SKILL.md)'s material-risk gate rather than requiring literal zero comments.
