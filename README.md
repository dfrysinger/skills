...
- **[design-doc](./skills/design-doc/SKILL.md)** : Write the durable design document that turns a systemic or critical change into a complete work order — objective, non-goals, reuse contract, failure model, invariants, deterministic check contract, Definition of Done — then rubber-duck and review it before any code exists. Owns the scope and architecture call; hands the finished document to [`development-loop`](./skills/development-loop/SKILL.md).
